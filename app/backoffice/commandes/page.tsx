...
const pageHeaderStyle: React.CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", flexWrap: "wrap", background: palette.white, border: `1px solid ${palette.slate200}`, borderRadius: "20px", padding: "18px" };
...
const secondaryButtonActiveStyle: React.CSSProperties = { border: `1px solid ${palette.indigoMain}`, color: palette.indigoDark, background: palette.indigoSoft };
...
const feedbackCardStyle: React.CSSProperties = { border: `1px solid ${palette.slate200}`, borderRadius: "20px", background: palette.white, padding: "16px", color: palette.slate500, fontWeight: 700 };
const summaryCardStyle: React.CSSProperties = { border: `1px solid ${palette.slate200}`, borderRadius: "20px", background: palette.white, padding: "12px", display: "flex", flexDirection: "column", gap: "4px" };
const summaryLabelStyle: React.CSSProperties = { color: palette.slate500, fontSize: "0.74rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.04em" };
const summaryValueStyle: React.CSSProperties = { color: palette.slate900, fontSize: "1.06rem", fontWeight: 800 };
...
const filtersCardStyle: React.CSSProperties = { border: `1px solid ${palette.slate200}`, borderRadius: "20px", padding: "10px", display: "flex", flexDirection: "column", gap: "10px", background: "#f8fafc" };
